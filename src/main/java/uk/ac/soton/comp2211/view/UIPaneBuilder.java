...
public class UIPaneBuilder extends StackPane {
  ...
  public static class OutputBox extends ParameterBox<Runway> {
    ...
    public OutputBox(Runway r, MainScene mainScene) {
      ...
      smallNotif = new Text();
      smallNotif.setWrappingWidth(200);
      ...
      getChildren()
          .addAll(
              ...
              hoverForCalc, calcButtonBox, expBox, new HBox(smallNotif));
    ...
    void setSmallNotif(String str) {
      System.out.println("Small notif: " + str);
      smallNotif.setText(str);
    }
    ...
    private void export() {
      try {
        ...
        notif.display(mainScene.getWindow(), "PDF successfully exported");
      } catch (Exception e) {
        notif.display(mainScene.getWindow(), "Couldn't save file");
      }
    }
