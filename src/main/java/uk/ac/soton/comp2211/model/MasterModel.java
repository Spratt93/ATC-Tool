...
public class MasterModel {
  ...
  public void removeCurrentAirport(Airport setNull) throws Exception {
    Airport a = currentAirport;
    airports.remove(a);
    setCurrentAirport(null);
    airportRemoveListener.removeParam(a);
  }
  public void removeCurrentRunway(Runway setNull) throws Exception {
    Runway r = currentRunway;
    currentAirport.removeRunway(r);
    setCurrentRunway(null);
    runwayRemoveListener.removeParam(r);
  }
  public void removeCurrentObstacle(Obstacle setNull) throws Exception {
    Obstacle o = currentObstacle;
    obstacles.remove(o);
    setCurrentObstacle(null);
    obstacleRemoveListener.removeParam(o);
  }
